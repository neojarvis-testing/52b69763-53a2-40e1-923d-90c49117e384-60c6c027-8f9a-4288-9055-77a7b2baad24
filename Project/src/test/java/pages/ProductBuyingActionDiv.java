...
public class ProductBuyingActionDiv {
    ...
    /**
     * @Description Handles the process of buying bracelets, including hovering,
     *              clicking, and verifying the order.
    ...
    /**
     * @Description Handles the process of buying rings, including clicking,
     *              interacting with live help, and capturing screenshots.
     * @param test An ExtentTest instance for reporting.
     * @throws InterruptedException Thrown if thread sleep is interrupted.
     */
    public static void ringbuying(ExtentTest test) throws InterruptedException {
        try {
            ...
            LoggerHandler.info("Clicked Carlex Ring");
            test.log(Status.INFO, "Clicked Carlex Ring");
