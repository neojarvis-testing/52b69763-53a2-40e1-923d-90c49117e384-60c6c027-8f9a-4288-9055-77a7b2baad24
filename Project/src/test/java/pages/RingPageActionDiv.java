...
public class RingPageActionDiv {
    ...
    /**
     * @Description Executes actions for selecting rings by dismissing popups and
     *              applying filters.
    ...
    /**
     * @Description Dismisses the popup by scrolling, refreshing the page, and
     *              interacting with the popup element.
     * @param test An ExtentTest instance for reporting.
     */
    ...
    /**
     * @Description Applies filters for selecting rings, such as 'For Her',
     *              category, brand, and Carlex options.
     * @param test An ExtentTest instance for reporting.
     */
    public static void selectfilterofring(ExtentTest test) {
        ...
        LoggerHandler.info("Clicked Category");
        test.log(Status.INFO, "Clicked Category");
