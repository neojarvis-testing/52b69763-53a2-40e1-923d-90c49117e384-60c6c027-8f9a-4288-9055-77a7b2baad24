...
public class WeddingPageActionDiv {
    ...
    /**
     * @Description Executes all wedding page actions, including dismissing popups,
     *              selecting metal types,
    ...
    /**
     * @Description Dismisses the popup by waiting for its clickability and
     *              interacting with it.
     * @param test An ExtentTest instance for reporting.
     */
    ...
    /**
     * @Description Hovers over and selects a gemstone and verifies the diamond
     *              option.
     * @param test An ExtentTest instance for reporting.
     */
    ...
    /**
     * @Description Hovers over and selects bracelet styles and verifies the
     *              bracelet section.
     * @param test An ExtentTest instance for reporting.
     */
    public static void clickbracelettype(ExtentTest test) {
        ...
        LoggerHandler.info("Clicked first Bracelet" + wb.getText(WeddingPageLocationDiv.bracelets));
        test.log(Status.INFO, "Clicked first Bracelet" + wb.getText(WeddingPageLocationDiv.bracelets));
    }
}