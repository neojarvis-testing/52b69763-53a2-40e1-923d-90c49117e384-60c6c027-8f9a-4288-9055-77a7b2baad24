...
public class HomePageDiv {
    ...
    /**
     * @Description Executes homepage actions like accepting cookies, navigating to
     *              wedding sections, and clicking bracelets.
    ...
    /**
     * @Description Accepts cookies on the homepage by waiting for the element to be
     *              visible and clicking on it.
     * @param test An ExtentTest instance for reporting.
     */
    public static void aceeptcookieshomepage(ExtentTest test) {
        ...
        LoggerHandler.info("Clicked on Accept cookies " + wb.getText(HomePageLocatorsDiv.Acceptcookies));
        test.log(Status.PASS, "Clicked on Accept cookies" + wb.getText(HomePageLocatorsDiv.Acceptcookies));
    }

    /**
     * @Description Navigates to the wedding section of the homepage by hovering
     *              over the wedding element.
     * @param test An ExtentTest instance for reporting.
     */
    ...
    /**
     * @Description Clicks on the bracelet element on the homepage and performs
     *              additional actions like scrolling and refreshing.
     * @param test An ExtentTest instance for reporting.
     */
    ...
    /**
     * @Description Executes actions specific to searching for rings on the
     *              homepage.
     * @param test An ExtentTest instance for reporting.
     */
    ...
    public static void acceptcookiesring(ExtentTest test) {
        ...
        wb.waitForElementToBeVisible(HomePageLocatorsDiv.Acceptcookies, 10);
        wb.clickOnElement(HomePageLocatorsDiv.Acceptcookies);
        LoggerHandler.info("Hover and clicked accept cookies" + wb.getText(HomePageLocatorsDiv.Acceptcookies));
        test.log(Status.PASS, "Clicked accept cookies" + wb.getText(HomePageLocatorsDiv.Acceptcookies));
    }

    /**
     * @Description Searches for rings in the search bar using data read from an
     *              Excel file.
     * @param test An ExtentTest instance for reporting.
     */
    public static void enterrings(ExtentTest test) {
        ...
        LoggerHandler.info("Hover and clicked searchbar");
        test.log(Status.PASS, "Clicked searchbar");
        String value = ExcelReader.readCellValue("Sheet1", "5", "value");
        wb.sendKeys(HomePageLocatorsDiv.searchbar, value);
        LoggerHandler.info("Rings sent in searchbar");
        test.log(Status.PASS, "Rings sent in searchbar");
        wb.waitForElementToBeVisible(HomePageLocatorsDiv.searchbar, 10);
        wb.enterAction(HomePageLocatorsDiv.searchbar);
        LoggerHandler.info("Enter action performed on searchbar");
        test.log(Status.PASS, "Enter action performed on searchbar");
    }
}